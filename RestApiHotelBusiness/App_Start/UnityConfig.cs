...
using HorelBusinessService.ImplementationsBD;
using HorelBusinessService.Interfaces;
using RestApiHotelBusiness.Controllers;
using System;
...
namespace RestApiHotelBusiness
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<AppRoleManager>(new HierarchicalLifetimeManager());
        }
    }
}